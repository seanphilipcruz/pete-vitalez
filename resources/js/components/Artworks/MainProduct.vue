                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                        ...
                                        <div class="row justify-content-center my-3">
                                            <div class="col-6">
                                                <div class="text-center btn-group">
                                                    <button type="button" data-bs-target="#order_form" data-bs-toggle="modal" class="btn btn-outline-dark">Order</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-center mb-3">
                                        <div class="col-8">
                                            <div class="h6">Do you want the same artwork but in different specs?</div>
                                            <div class="text-center">
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#request_form" class="btn btn-outline-dark">Request</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
