                            ...
                            <div class="col-6">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-9">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input id="email" type="email" class="form-control" :class="form_errors.email ? 'is-invalid' : ''" placeholder="Email Address (Optional)" v-model="form.email">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input id="zip_code" type="text" class="form-control" :class="form_errors.zip_code ? 'is-invalid' : ''" placeholder="Zip Code (Optional)" v-model="form.zip_code">
                                        ...
                                        <div class="form-floating">
                                            <select id="is_framed" class="form-select" v-model="form.is_framed">
                                                <option value="0">No Frame (Regular Price)</option>
                                                <option value="1">Framed (Additional of ₱{{ artwork.frame_price }})</option>
                                            </select>
                                            <label for="is_framed">Artwork Frame</label>
                                            <div v-if="form_errors.is_framed" class="invalid-feedback">
                                                <ul class="m-0" v-for="value in form_errors.is_framed">
                                                    {{ value }}
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="col-6">
                                <div class="row justify-content-evenly mb-3">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <div class="mb-2" v-html="artwork.description"></div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between text-center mb-3">
                                    <div class="h4">Total</div>
                                    <div class="h5">₱ {{ form.is_framed === "1" ? artwork.price + artwork.frame_price : artwork.price }}</div>
                                    <hr class="text-dark" />
                                </div>
                                <div class="row">
                                    <div class="col-12">
