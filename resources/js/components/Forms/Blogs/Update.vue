    ...
    <form ref="form" v-model="valid" novalidate>
        <div class="card-header">
            <div class="card-title">
                <div class="h3 my-2">Update {{ blog.title }}</div>
            </div>
        </div>
        <div class="card body">
            <div class="my-3">
                ...
                <div class="row justify-content-center">
                    <div class="col-4 text-center">
                        <button id="submit_button" type="button" class="btn btn-outline-dark" @click="submit"><font-awesome-icon :icon="['fas', 'check-circle']"></font-awesome-icon> Update</button>
                    </div>
                </div>
            </div>
        </div>
